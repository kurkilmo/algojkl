...
const PestitDescription = () => (
  <div className="hallitus-pesti-info">
    ...
    <p>
      ...
      <br />
      <br />
      <strong>Varapuheenjohtaja</strong> sijaistaa puheenjohtajaa kokouksissa
      tämän estyessä, ja toimii tiiviissä yhteistyössä puheenjohtajan kanssa.
      <br />
      <br />
      <strong>Sihteeri</strong> kirjoittaa kokouksissa pöytäkirjan (virallinen
      dokumentti kokouksissa läpikäytävistä asioista).
      <br />
      <br />
      <strong>Rahastonhoitaja</strong> maksaa laskuja, huolehtii kirjanpidosta
      ja vastaa killan pankkitilistä.
      <br />
      <br />
      <strong>Yritysvastaava</strong> solmii ja ylläpitää yhteistyösopimuksia
      yritysten kanssa sekä vastaa yritystiimin toiminnasta.
      <br />
      <br />
      ...
      projektiluontoisista tapahtumista kuten vuosijuhlista, lakinlaskijaisista
      ja kastajaisista.
      <br />
      <br />
      ...
      tilejä ja tiedottaa jäsenille tapahtumista ja muista tärkeistä asioista. Viestintää hoitaa aktiivit: Venla Veijalainen Ja Viola Maunuksela
      <br />
      <br />
      <br />
      <strong></strong>
