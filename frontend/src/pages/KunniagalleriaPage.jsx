    ...
    return (
        <div>
            ...
            <div className="kunnia-container">   
                ...
                <p><i>Kunniajäsen on killan toimintaa erityisen ansiokkaasti tukenut henkilö. Kunniajäsenyys on Algon korkein kunnianosoitus.</i></p>    
                <ul>
                    <li>
                        Jari Haapasaari (Nimetty 2023)
                    </li>
                </ul>
                <h1>Vuoden Algolainen - palkinnon voittajat</h1>
                <p><i>Vuoden algolainen on jäsenten äänestyksessä päättämä, joka on osoittanut merkittävää kiinnostusta yhdistyksen toimintaa kohtaan ja edistänyt jäsenten välistä yhteishenkeä.</i></p>
                <ul>
                    <li>
            ...
            <div className="kunnia-container">
                <h1>
                    Perustajajäsenet & Hallitus 2022
                </h1>
                ...
                <ul className="perustaja">
                    ...
                    <li>
                        <strong>
                        Annarella Manninen 
                        </strong>, Varapuheenjohtaja & Kopo 2022
                    </li>
                    <li>
                        <strong>
                        Topias Liljegren
                    ...
                    <li>
                        <strong>
                            Minea Nupponen & Jesse Haimi
                        </strong>,
                    Tapahtuma- ja somevastaava(t)
                    </li>
                    <li>
                        <strong>
                            Lassi Laitinen
                        </strong>,
                        Fuksivastaava ja sosiaalipoliittinen vastaava
                    </li>
                </ul>
                </div>
            </div>
