  ...
  return (
    <div>
      ...
      <div className='yhteydenotto-container'>
        ...
        <p>
            Algo ry:n yksi tärkeimpiä tehtäviä on edunvalvonta ja kilta pyrkii vaikuttamaan opetuksen kehittämiseen. Tällä lomakkeella voit antaa palautetta tietystä kurssista liittyen opetukseen, arviointiin tai mihin vaan. <strong> Tämä palaute ei korvaa yliopiston virallista tai opettajan antamaa kurssipalautelomaketta! </strong>
        </p>
        <p>
        ...
        <p>Linkki lomakkeeseen: <a href="https://forms.gle/5vLF7HQQosCeov5s8">SopoKopoLomake</a></p>
        <h1>
