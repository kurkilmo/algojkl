...
const Merkit = () => {
    return (
        ...
        <div>
            ...
            <br />
            <br />
            6§ Hallitusmerkki myönnetään yhdistyksen istuvan hallituksen jäsenille. Hallitusmerkki voidaan myöntää myös yhdistyksen hallituksen entiselle jäsenelle. Hallitusmerkki on väriltään hopeinen ja kooltaan xx mm.
            <br />
            <br />
            ...
            <br />
            <br />
            11§  Tämä ohjesääntö on hyväksytty yhdistyksen kokouksessa 26.5.2023. Se on voimassa toistaiseksi. Tämän ohjesäännön muuttamisesta päättää yhdistyksen kokous ehdottomalla äänienemmistöllä.</p>
        ...
        <div className="Lakki-container">
                    <h1>Teekkarilakki</h1>
                        ...
                        <br />
                        <br />
                        Kaikki Jyväskylän yliopiston teekkariopiskelijat ovat oikeutettuja lakin ostoon riippumatta siitä, ovatko he Algo ry:n jäseniä vai eivät. Algo ry kuitenkin tilaa lakit ja voit ostaa sen kide.appin kautta, kun tilaus aukeaa. Tilauksen aukeamisesta tiedotetaan kaikille Jyväskylän yliopiston tekniikan opiskelijoille.
                        <br />
                        <br />
                        <a href="https://kide.app/community/56059c50-ac32-4678-b061-a6bba8369761">Linkki Algo ry:n kide.appiin</a>
                        </p>
                        <p>kuva</p>
                    <h2>Lakinkäyttösäännöt</h2>
                        <p>
                           <strong> 1 § Teekkarilakki </strong>
                            ...
                            Tämä ohjesääntö hyväksyttiin ensimmäistä kertaa keväällä 2022. Ohjesääntöä voidaan muuttaa tätä ohjesääntöä ylläpitävän yhdistyksen kokouksessa.
                    </p>
                </div>
                <div>
                <h1>Vuosijuhlaetiketti</h1>
                    ...
                    <br />
                    <i>
                    “Juhlanauhaa sekä kunnia-, ansio- ja hallitusmerkkiä käytetään vain juhlapuvussa akateemisissa juhlatilaisuuksissa.
                    <br />
                    <br />
                    Juhlanauhaa kannetaan siten, että se kulkee oikealta olkapäältä rinnan yli vasemmalle lantiolle, vaaleanpunainen väri yläpuolella. Juhlanauhaa kannetaan juhlapuvussa liivin alla ja tummassa puvussa liivin ja solmion päällä. Mekon kanssa juhlanauhaa voi kantaa taiteltuna ruusukkeena vasemmalla puolella rintaa, vaaleanpunainen väri päällimmäisenä, tai kuten juhlapuvussa. Juhlanauha ei saa koskettaa paljasta ihoa.
                    <br />
                    ...
                    <br />
                    <br />
                    Ansiomerkkeihin ja juhlanauhaan liittyvät säännöt löydät kokonaisuudessaan <a href="/ansiomerkit">täältä</a>.
                    </p>
            ...
            <h2>Haalareiden käyttäminen</h2>
                <ul>
                    ...
                    <li>
                        Haalareita käytetään kaikissa opiskelijatapahtumissa, ellei tapahtuman pukeutuminen erikseen toisin mainitse.
                    </li>
                    <li>
                        Kun haalareita pidetään vyötäröllä, niin selkäosa taitetaan siten, että killan logo näkyy.
                    </li>
                    <li>
            ...
            <ul>
                <li>
                        Haalarimerkit ommellaan käsin.
                </li>
                <li>
                        Haalarimerkkejä ei saa liimata tai ommella ompelukoneella.
                </li>
                <li>
                        Haalarimerkkejä ei tule ommella sponsoreiden logojen päälle, mikäli tilaa on. 
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    Haalarit pestään siten, että olet itse niiden sisällä (esimerkiksi järvessä).
                </li>
            </ul>
        </div>
