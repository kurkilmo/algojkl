  ...
  return (
    <div>
      ...
      <div className="collab-container">
        ...
        <p>Yritysyhteistyöasioissa voit ottaa yhteyttä Algon yritysuhdevastaavaan: <br />
        <strong>Leevi Kopakkala: yritys@algojkl.com</strong></p>
        <h3>Tapahtumat</h3>
        <p>Tapahtuma-asioissa voit ottaa yhteyttä Algon tapahtumavastaaviin: <strong>tapahtumat@algojkl.com</strong></p>
        <br />
        <h3>Killan Ulkosuhteet</h3>
        <p>Killan ulkosuhteita ylläpitää Algon varapuheenjohtaja: <br />
        <strong>Essi Pakkala: vpj@algojkl.com</strong> </p>
        <h3>Muita idoita?</h3>
        <p>Meille voi aina ehdottaa uusia yhteistyökuvioita! <br />
